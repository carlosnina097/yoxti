          ...
          <div class="row">
            <div class="col-xs-12 col-lg-12">
              <form method="get" action="">
                ...
                $query = "SELECT p.nombre_proyecto, e.nombre_empresa, c.nombres_cliente, d.importe_donacion, d.fecha_donacion, d.id_donacion FROM donacion d 
                ...
                while ($tuple = mysqli_fetch_assoc($result)) {
                  ...
                  <td>'.$tuple['nombre_empresa'].'</td>
                  <td>'.$tuple['nombres_cliente'].'</td>
                  <td>'.$tuple['id_donacion'].'</td>
                  <td>'.$tuple['importe_donacion'].'</td>
                  <td>'.$tuple['fecha_donacion'].'</td></tr>';
                  $totalItem += 1;
                }

                if ($totalItem < 1) {
                  print "<div class='jumbotron'><h4>No existen Donaciones</h4></div>";
                ...
                for ($b=1;$b<=$p;$b++) {
                  ?><a href="donacion_list.php?page=<?php echo $b; ?>&cc="><?php echo $b." "; ?></a><?php
                }
                echo "<br>";
