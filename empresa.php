          ...
          <div class="jumbotron">
            <form method= "post" action="">
              <?php
                  ...
                  //session_start();
                  $NombreEmpresa = isset($_REQUEST['NombreEmpresa']) ? (String)trim($_REQUEST['NombreEmpresa']): "";
				          $RUC = isset($_REQUEST['RUC']) ? (String)trim($_REQUEST['RUC']): "";
				          $URL = isset($_REQUEST['URL']) ? (String)trim($_REQUEST['URL']): "";
                  ...
                  if (isset($_POST['RegistrarEmpresa'])) {
                    ...
                    if (!$NombreEmpresa || !$RUC || !$URL || !$Imagen || !$Correo) {
                     ...
                     print "<div class='jumbotron'><h4>Es necesario completar todos los campos</h4></div>";
                      ...
                      if ( !$NombreEmpresa || !$RUC || !$URL || !$Imagen || !$Correo ) {
                        ...
                        $query = "INSERT into empresa (nombre_empresa,ruc_empresa,url_empresa,correo_empresa,imagen_empresa)
                                VALUES (".$values.")";
                        if (mysqli_query($dbcon, $query)) {
                          print "<div class='jumbotron'><h4>Se ha registrado la nueva empresa correctamente.</h4></div>";
              ...
              <fieldset>
                ...
                <input type="submit" value="Registrar Empresa" name="RegistrarEmpresa">
              </fieldset>
            </form>
